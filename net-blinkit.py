...
#
# Replace Public below with the SNMP read-only community string that you need to connect to your router
#

	try:
		data = subprocess.check_output("snmpget -v 1 -c public 192.168.1.1 " + oid, shell = True)
...
while (1):
  ...
  #
  #Calculate the actual speed of your internet connection in bytes.  
  #
